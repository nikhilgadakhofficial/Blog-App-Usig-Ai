  ...
  return (
    ...
    <div className=' mx-8 sm:mx-16 xl:mx-24 relative'>
        ...
        <div className=' text-center mt-20 mb-8'>
            ...
            <h1 className=' text-3xl sm:text-6xl  font-semibold sm:leading-16 text-gray-700 '>Your own <span className=' text-primary'>blogging</span> platfrom</h1>

            <p className=' my-6 sm:my-8 max-w-2xl m-auto max-sm:text-x5 text-gray-700'>
              This is your space to think out loud, to share what matters,
              and to write without filters. Whether it's one word or a thousand ,your story right here.
            </p>
        ...
        <img src={assets.gradientBackground} className=' absolute -top-52 -z-1 opacity-50'/>
