...
function BlogList() {
  ...
  const {blogss,input} = useAppContext();
  ...
  const filteredBlogs = ()=>{
    ...
    return blogss.filter((blog)=> blog.title.toLowerCase().includes(input.toLowerCase()) || blog.category.toLowerCase().includes(input.toLowerCase()))
  }
